...
public class GenericTypeResolverTest {
    ...
    // Test classes with generic information
    static class GenericTestClass<E> {
        E element;
    ...
    static class MultiParamTestClass<K, V> {
        K key;
        V value;
    ...
    static class BoundedTestClass<T extends Number> {
        T number;
    ...
    static class NestedBoundTestClass<T extends List<String>> {
        T list;
    ...
    static class TestComparable implements Comparable<String> {
        @Override
